        ...
        <div class="col-12 p-5 bg-white">
            ...
            <div class="row">
                ...
                <div class="col text-end">
                    <a href="?ct=agent&mt=upload_file_frm" class="btn btn-secondary"><i
                            class="fa-solid fa-upload me-2"></i></i>Carregar
                        ficheiro</a>
                    <a href="?ct=agent&mt=new_client_frm" class="btn btn-secondary"><i
                            class="fa-solid fa-plus me-2"></i>Novo cliente</a>
                </div>
            </div>
                    ...
                    <tbody>
                        <?php foreach ($clients as $client): ?>
                            <tr>
                                ...
                                <td class="text-end">
                                    <a href="?ct=agent&mt=edit_client&id=<?= aes_encrypt($client->id) ?>"><i
                                            class="fa-regular fa-pen-to-square me-2"></i>Editar</a>
                                    <span class="mx-2 opacity-50">|</span>
                                    <a href="?ct=agent&mt=delete_client&id=<?= aes_encrypt($client->id) ?>"><i
