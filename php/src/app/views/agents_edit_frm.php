                    ...
                    <div class="col-10">
                        ...
                        <form action="?ct=admin&mt=edit_agent_submit" method="post" novalidate>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="email" name="text_name" id="text_name" value="<?= $agent->name ?>"
                            ...
                            <div class="mb-3">
                                ...
                                <select name="select_profile" id="select_profile" class="form-control" required>
                                    <option value="admin" <?= $agent->profile == 'admin' ? 'selected' : '' ?>>
                                        Administrador</option>
                                    <option value="agent" <?= $agent->profile == 'agent' ? 'selected' : '' ?>>Agente
                                    </option>
                                </select>
                            </div>

                            <div class="mb-3 text-center">
                                <a href="?ct=admin&mt=agents_management" class="btn btn-secondary px-4"><i
                                        class="fa-solid fa-xmark me-2"></i>Cancelar</a>
                                <button type="submit" class="btn btn-secondary px-4"><i
                                        class="fa-solid fa-pen-to-square me-2"></i>Atualizar</button>
                            </div>
