                    ...
                    <div class="col-10">
                        ...
                        <form action="?ct=agent&mt=edit_client_submit" method="post">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="text_name" id="text_name" value="<?= $client->name ?>"
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6 col-sm-12">
                                    ...
                                    <input type="text" class="form-control" name="text_birthdate" id="text_birthdate"
                            ...
                            <div class="row mb-3">
                                <div class="col-md-6 col-sm-12">
                                    ...
                                    <input type="email" class="form-control" name="text_email" id="text_email"
                            ...
                            <div class="mb-3">
                                <label for="text_interests" class="form-label">Interesses<span
                                        class="ms-4"><small>(Palavras separadas por virgulas)</small></span></label>
                            ...
                            <div class="mb-3 text-center">
                                ...
                                <button type="submit" class="btn btn-secondary"><i
                                        class="fa-regular fa-floppy-disk me-2"></i>Atualizar</button>
                            </div>
