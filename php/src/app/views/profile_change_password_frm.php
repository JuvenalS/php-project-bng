            ...
            <div class="card p-4 mb-5">
                ...
                <form action="?ct=main&mt=change_password_submit" method="post" novalidate>
                    <div class="row justify-content-center">
                        <div class="col-8">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="password" name="text_current_password" id="text_current_password"
                    ...
                    <div class="mb-3 text-center">
                        <a href="?ct=main&mt=index" class="btn btn-secondary px-3"><i
                                class="fa-solid fa-xmark me-2"></i>Cancelar</a>
                        <button type="submit" class="btn btn-secondary px-3"><i
                                class="fa-solid fa-check me-2"></i>Alterar</button>
                    </div>
