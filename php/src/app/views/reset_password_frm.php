            ...
            <div class="card p-4">
                ...
                <div class="row justify-content-center">
                    <div class="col-8">
                        ...
                        <p class="text-center">Indique o seu nome de utilizador.<br>Vamos enviar um email com um
                            <strong>código</strong> para recuperar a password.
                        </p>
                        ...
                        <form action="?ct=main&mt=reset_password_submit" method="post">
                            ...
                            <div class="mb-4 text-center">
                                <a href="?ct=main&mt=index" class="btn btn-secondary"><i
                                        class="fa-solid fa-caret-left me-2"></i>Voltar</a>
                                <button type="submit" class="btn btn-secondary">Enviar código<i
