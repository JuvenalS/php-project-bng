                        ...
                        <form action="?ct=main&mt=insert_code_submit&id=<?= aes_encrypt($id) ?>" method="post">
                            ...
                            <div class="row justify-content-center mb-4">
                                <div class="col-8">
                                    ...
                                    <input type="text" name="text_code" id="text_code" value=""
                                        class="form-control form-control-lg fw-bold text-center" required>
                                </div>
                            </div>
                            ...
                            <div class="mb-4 text-center">
                                ...
                                <button type="submit" class="btn btn-secondary px-4">Avançar<i
