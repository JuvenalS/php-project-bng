                ...
                <div class="col p-1">
                    ...
                    <div class="card p-3">
                            ...
                            <div class="col-5">
                                <table class="table table-striped">
                                    <tr>
                                        ...
                                        <td class="text-start">
                                            <strong><?= $global_stats['total_agents']->value ?></strong>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="text-start">Número total de clientes:</td>
                                        <td class="text-start">
                                            <strong><?= $global_stats['total_clients']->value ?></strong>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="text-start">Número total de clientes inativos:</td>
                                        <td class="text-start">
                                            <strong><?= $global_stats['total_deleted_clients']->value ?></strong>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="text-start">Número médio de clientes por agente:</td>
                                        <td class="text-start">
                                            <strong><?= sprintf("%d", $global_stats['average_clients_per_agent']->value) ?></strong>
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-start">
                                            <strong><?= sprintf("%.2f", $global_stats['average_age']->value) ?></strong>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="text-start">Percentagem de clientes homens:</td>
                                        <td class="text-start">
                                            <strong><?= sprintf("%.2f", $global_stats['percentage_males']->value) . "%" ?></strong>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="text-start">Percentagem de clientes mulheres:</td>
                                        <td class="text-start">
                                            <strong><?= sprintf("%.2f", $global_stats['percentage_females']->value) . '%' ?></strong>
                                        </td>
                                    </tr>
                                </table>
                            </div>
                        ...
                        <div class="text-center">
                            <a href="?ct=admin&mt=create_pdf_report" target="_blank" class="btn btn-secondary px-4"><i
                                    class="fa-solid fa-file-pdf me-2"></i>Criar relatório em PDF</a>
                        </div>
